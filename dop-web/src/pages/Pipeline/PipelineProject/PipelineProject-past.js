...
export default class PipelineProject extends Component {
    constructor(props) {
        ...
        this.state = {
            ...
            iframeSrc : "http://jenkins.dop.clsaa.com/blue/organizations/jenkins/simple-java-maven-app/detail/simple-java-maven-app/2/pipeline/26/"
    ...
    //             });
    //             console.log(self.state.jenkinsRuns);
                                    ...
                                    {/*return (*/}
                                        {/*<div className="have-result-wrap" key={index}*/}
                                            ...
                                            {/*<div className={stageClass} key={index}*/}
                                                ...
                                                {/*{(() => {*/}
                                                    {/*console.log(this.state.jenkinsRuns)*/}
                                                    {/*console.log(index)*/}
                                                    {/*if (this.state.jenkinsRuns != undefined && this.state.jenkinsRuns.stages.length > 1){*/}
